...
import static com.antares.sandbox.constant.SandBoxConstants.JAVA_CLASS_NAME;
...
public abstract class JavaSandboxTemplate {
    ...
    public final ExecuteCodeResponse executeJavaCode(List<String> inputList, String code) {
        ...
        try {
            ...
            return ExecuteCodeResponse.builder()
                    ...
                    .msg(AppHttpCodeEnum.DANGER_CODE.getMsg())
                    .build();
        }
    ...
    protected File saveFile(String code, String dir) {
        ...
        if(foundWord != null){
            throw new BusinessException(AppHttpCodeEnum.DANGER_CODE);
        }
